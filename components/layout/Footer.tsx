        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex items-center gap-3 mt-4">
              <SocialLink href={siteConfig.links.twitter} icon={<Twitter className="w-4 h-4" />} />
              <SocialLink href={siteConfig.links.github}  icon={<Github  className="w-4 h-4" />} />
              <SocialLink href={siteConfig.url}           icon={<Globe   className="w-4 h-4" />} />
            </div>
          </div>
